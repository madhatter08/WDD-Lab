            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title mb-2"><i class="mdi mdi-monitor-dashboard mr-2"></i>Admin Profile</h4>
                        <div class="">
                            <ol class="breadcrumb">
                                                ...
                                                <div class="row">
                                                    <div class="col-7">
                                                        <div class="seling-report">
                                                            <h5 class=" seling-data-detail">Term: <?php echo $data['termStart'] . ' - ' . $data['termEnd']; ?></h5>
                                    ...
                                    <div class="tab-content" id="profile-tabContent">
                                        <div class="tab-pane fade show active" id="profile-dash">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="">
                                                        <form class="form-horizontal form-material mb-0" action="../update-official.php" method="post" id="updateForm">
                                                            <div class="form-group">
                                                                <h4>Profile Picture</h4>
                                                                <input type="file" id="input-file-now-custom-1" class="dropify" name="image" data-default-file="../img/<?php echo $data['image']; ?>">
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-3"><label>Suffix</label><input type="text" placeholder="i.e. Sr./Jr." class="form-control" name="suffix" value="<?php echo $data['suffix']; ?>"></div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-md-6"><label>Birthdate</label><input type="date" placeholder="Select your birthdate" class="form-control" name="birthdate" id="example-email" value="<?php echo $data['birthdate']; ?>"></div>
                                                                <div class="col-md-6"><label>Phone Number</label><input type="text" placeholder="Enter your phone number" class="form-control" name="phonenum" value="<?php echo $data['phonenum']; ?>"></div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-md-4"><label>Position</label><input type="text" placeholder="Position" class="form-control" name="position" value="<?php echo $data['position']; ?>"></div>
                                                                <div class="col-md-4"><label>Term Start</label><input type="text" placeholder="Year" class="form-control" name="termStart" value="<?php echo $data['termStart']; ?>"></div>
                                                                <div class="col-md-4"><label>Term End</label><input type="text" placeholder="Year" class="form-control" name="termEnd" value="<?php echo $data['termEnd']; ?>"></div>
                                                            </div>
