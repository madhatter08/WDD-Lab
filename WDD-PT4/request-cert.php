...
<script type="text/javascript">
    function delete_id(requestId) {
        if (confirm('Are you sure to delete this record?')) {
            window.location.href = 'request-cert.php?delete_id=' + requestId;
                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-right align-item-center mt-2">
                            <a href="../pdf-requests.php" class="btn btn-info px-4 align-self-center report-btn">Create Report</a>
                        </div>
                        <h4 class="page-title mb-2"><i class="mdi mdi-monitor-dashboard mr-2"></i>Request Certificates</h4>
                        <div class="">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">Monitoring of Request Certificates</li>
                            </ol>
                        </div>
                    </div>
                    <!--end page title box-->
                                ...
                                <div class="card-body">
                                    <table id="footable-3" class="table mb-0" data-paging="true" data-filtering="true" data-sorting="true">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-name="certType">Certificate Type</th>
                                                <th data-name="certType">Purpose</th>
                                                <th data-name="dataSent" data-breakpoints="xs sm" data-type="date" data-format-string="MMMM Do YYYY">Data Sent</th>
                                                <th data-name="jobTitle" data-breakpoints="xs">Requester</th>
                                                <th data-name="jobTitle" data-breakpoints="xs">Status</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['delete_id'])) {
                                                $query = "DELETE from request_tbl WHERE requestId=" . $_GET['delete_id'];
                                                mysqli_query($con, $query);
                                                //header('location:admin.php');
                                            }
                                            $retrieve = mysqli_query($con, "select * from request_tbl");
                                            $ctr = 1;
                                            while ($rows = mysqli_fetch_array($retrieve)) { ?>
                                                <tr requestId="<?php echo $rows['requestId']; ?>">
                                                    <td><?php echo $rows['requestId']; ?></td>
                                                    <td><?php echo $rows['fullname']; ?></td>
                                                    <td><?php echo $rows['certType']; ?></td>
                                                    <td><?php echo $rows['purpose']; ?></td>
                                                    <td><?php echo $rows['requestDate']; ?></td>
                                                    <td><?php echo $rows['requester']; ?></td>
                                                    <td><?php echo $rows['status']; ?></td>
                                                    <td>
                                                        <a href="../request-edit.php?id=<?php echo $rows['requestId']; ?>">Edit</a>
                                                        <a href=javascript:delete_id(<?php echo $rows['requestId']; ?>)>Delete</a>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="modal fade" id="editor-modal" tabindex="-1" role="dialog" aria-labelledby="editor-title">
                                        <div class="modal-dialog" role="document">
                                            ...
                                            ?>
                                            <form class="modal-content form-horizontal" id="editor" action="../update-request.php" method="post">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group required row">
                                                        ...
                                                        <div class="col-sm-9"><input type="text" class="form-control" id="firstName" name="fullname" value="<?php echo $rows['fullname']; ?>" placeholder="" required></div>
                                                    </div>
                                                    <div class="form-group require row">
                                                        <label for="lastName" class="col-sm-3 control-label">Certificate Type</label>
                                                        <div class="col-sm-9"><input type="text" class="form-control" id="lastName" name="certType" value="<?php echo $rows['certType']; ?>" placeholder="" required></div>
                                                    </div>
                                                    <div class="form-group require row">
                                                        <label for="lastName" class="col-sm-3 control-label">Purpose</label>
                                                        <div class="col-sm-9"><input type="text" class="form-control" id="lastName" name="certType" value="<?php echo $rows['certType']; ?>" placeholder="" required></div>
                                                    </div>
                                                    <div class="form-group required row">
                                                        <label for="startedOn" class="col-sm-3 control-label">Requester</label>
                                                        <div class="col-sm-9"><input type="text" class="form-control" id="startedOn" name="requester" value="<?php echo $data['firstname'] . ' ' . $data['lastname']; ?>" placeholder="" required></div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="dob" class="col-sm-3 control-label">Position</label>
                                                        <div class="col-sm-9"><input type="text" class="form-control" id="dob" name="position" value="<?php echo $data['position']; ?>" placeholder=""></div>
                                                    </div>
                                                </div>
